...
**Prerequisites:** Day 1 completion (Scratch basics, variables, conditions)
...
**Learning Objectives:**
- Extend Scratch skills with advanced concepts (cloning, broadcasting, lists)
- Create more complex interactive projects and games
- Apply Scratch to curriculum subjects (maths, science, languages)
- Develop assessment strategies and classroom management for Scratch
...
- Reference: Day 1 materials and [day-01-scratch](../day-01-scratch/) for review
